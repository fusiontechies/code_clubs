...
export default function TodayPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex flex-col items-center text-white">
            <ToastContainer />
            <h1 className="text-center text-5xl md:text-4xl sm:text-3xl font-extrabold mt-8 mb-8">
            ...
            >
                <div className="mb-4">
                    ...
                    <input
                        ...
                        required
                        className="w-full px-4 py-2 rounded bg-gray-700 text-white focus:ring-2 focus:ring-blue-500 custom-calendar"
                    />
                </div>
                ...
                {selectedCategory === 'Health' && (
                    <div className="mb-4">
                        <label htmlFor="health" className="block text-lg font-medium mb-2">
                            Health
                        </label>
                        <select
                            ...
                            onChange={handleChange}
                            className="w-full mb-2 px-4 py-2 rounded bg-gray-700 text-white focus:ring-2 focus:ring-blue-500"
                        >
                ...
                {selectedCategory === 'Achievement' && (
                    <div className="mb-4">
                        <label htmlFor="achievement" className="block text-lg font-medium mb-2">
                            Achievement
                        </label>
                        <textarea
                            id="achievement"
                ...
                {selectedCategory === 'Water' && (
                    <div className="mb-4">
                        <label htmlFor="water" className="block text-lg font-medium mb-2">
                            Water Intake (Liters)
                        </label>
                        <input
                            type="number"
                ...
                {selectedCategory === 'Miscellaneous' && (
                    <div className="mb-4">
                        <label htmlFor="miscellaneous-text" className="block text-lg font-medium mb-2">
                            Miscellaneous
                        </label>
                        <textarea
                            ...
                            className="w-full px-4 py-2 rounded bg-gray-700 text-white focus:ring -2 focus:ring-blue-500 mb-4"
                        />
                        <input
                            type="file"
                            ...
                            accept="image/*"
                            onChange={handleChange}
                            className="w-full text-white focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                )}
